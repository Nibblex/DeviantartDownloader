...
def run():
    ...
    parser.add_argument("--only", nargs="+", metavar="WHAT",
                        help=f"Keep only the works matching all of {', '.join(ONLY_FILTERS)} "
                             ...
                             "naming both is the same as naming neither, while "
                             "'nsfw'/'sfw' read the maturity flag and narrow whatever "
                             "the kind left -- '--only literature nsfw' is the mature "
                             "literature. 'ai'/'no-ai' and "
